...
insert into company (CompanyName, Industry, Website, Adress, ContactEmail, PhoneNumber) values 
	...
	('Global Financial Group', 'Finance', 'www.globalfinancial.com', '455 Wall St New York NY 10005', 'nquiry@globalfinancial.com', '+1 (212) 555-2233'),
...
delete from company where CompanyName = 'GreenLeaf Organics';